...
import type {
	...
	AdmintorsControllerFindAllByFieldsData,
	AdmintorsControllerFindAllByFieldsError,
 ...
 * 通过字段值查询所有数据
 */
export const admintorsControllerFindAllByFields = <
	ThrowOnError extends boolean = false
>(
	options: Options<AdmintorsControllerFindAllByFieldsData, ThrowOnError>
) => {
	return (options?.client ?? client).post<
		AdmintorsControllerFindAllByFieldsResponse,
		AdmintorsControllerFindAllByFieldsError,
 ...
 * 通过字段值查询所有数据
 */
export const rolesControllerFindAllByFields = <
	ThrowOnError extends boolean = false
>(
	options: Options<RolesControllerFindAllByFieldsData, ThrowOnError>
) => {
	return (options?.client ?? client).post<
		RolesControllerFindAllByFieldsResponse,
		RolesControllerFindAllByFieldsError,
